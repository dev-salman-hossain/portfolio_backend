...
router.post("/register", rateLimiters.register, AuthController.register);

// Route 2: ইমেইলে পাওয়া OTP দিয়ে ইমেইল ভেরিফাই করবে
router.post("/verify-email", rateLimiters.otp, AuthController.verifyEmail);
...
router.post("/verify-forgot-password-otp", rateLimiters.otp, AuthController.verifyForgotPasswordOTP);
